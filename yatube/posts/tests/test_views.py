...
class PostPagesTest(TestCase):
    ...
    def test_posts_pages_uses_correct_template_all_users(self):
        """Проверка использования posts view ожидаемых шаблонов
    ...
    def test_posts_create_post_correct_template_authorized(self):
        """Проверка использования posts view ожидаемых шаблонов авторизованным
        пользователем."""
        template_pages = {
    ...
    def test_posts_create_post_correct_template_authorized(self):
        """Проверка использования posts view ожидаемых шаблонов автором."""
